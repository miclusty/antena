  ...
  return (
    ...
    >
      ...
      <main class="px-5 py-6">
        ...
        {/* Reader-style Q&A generated by AKIRA's FAQ generator
            (core/faq_generator.py). Collapsed by default so the article
            body leads; expands to show 3-5 questions with answers and
            a "X fuentes" badge so users can quickly understand "qué es
            X?" without reading every source. */}
        <FaqsSection clusterId={n().clusterId} />
