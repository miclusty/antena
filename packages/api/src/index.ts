...
import { emergingRoutes } from "./routes/emerging";
...
app.route("/api/clusters", contradictionRoutes);
app.route("/api/clusters", faqRoutes);
app.route("/api/emerging", emergingRoutes);
